...
export function CheckForUpdate():Promise<appupdate.Status>;
...
export function RestartToUpdate(arg1:boolean):Promise<main.UpdateRestartResult>;
...
export function UpdateStatus():Promise<appupdate.Status>;
